...
async function apiCall() {
  try {
    ...
    document.getElementById("lat").innerText = `Latitude: ${25.61242}`;
    document.getElementById("long").innerText = `Longitude: ${85.1089757}`;
    ...
    document.getElementById(
      "map"
    ).src = `https://maps.google.com/maps?q=25.61242, 85.1089757&output=embed`;
